...
def get_img(data_path, path, save_path=None, crop_size=(296, 280)):
    img_file = path
...
def test():
    ...
    x = get_img(args.seg_data_path, path, os.path.join(args.result_path, img_name), crop_size=(args.seg_crop_x, args.seg_crop_y))
