...
def copy_segmented_images(masks_dir, input_images_dir, output_dir, input_ext='.jpg'):
    """
...
if __name__ == '__main__':
    ...
    m_dir, i_dir, o_dir = os.path.join('seg_data', 'segmentation_masks'), os.path.join('seg_data', 'img_align_celeba'), os.path.join('seg_data', 'data')
